...
// The input is only given to initialize the room and the robot's position internally. You must solve 
// this problem "blindfolded". In other words, you must control the robot using only the four mentioned 
